...
return [
    ...
    'title' => 'Plataforma de Inteligência de Compras — API',

    'description' => 'API para integração de dados de compras de múltiplos ERPs, análises de TCO, benchmark e alertas.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtenha seu token via **POST /api/v1/auth/login** com `email` e `password`. Use o valor retornado no header: `Authorization: Bearer {TOKEN}`.',
    ],
    ...
    'groups' => [
        ...
        'order' => [
            ...
            'Benchmark de Estrutura de Custo',
            'Fornecedores',
            'Contatos',
            'Alertas',
            'Status de Ingestão',
